...
export class VehicleDetails implements IDetailsComponent {
                                    ...
                                    <Stack gap={1}>
                                        <div className="p-2">Pilots</div>
                                        {
                                            vehicle.pilots.map((x, i) =>
                                                <div key={i} className="p-2 d-flex flex-row-reverse"><Link to={getRelativeInnerPath(x)}>Pilot - {i+1}</Link></div>
                                            )}
                                    </Stack>
                                </Col>
