                        ...
                        <div className="mt-md-3 p-2 border bg-light">
                            <Stack gap={1}>
                                ...
                                <Stack direction="horizontal" gap={3}>
                                    ...
                                    <div className="p-2 ms-auto"><Link to={getRelativeInnerPath(species.homeworld)}>Homeworld</Link></div>
                                </Stack>
                            }
                                <Stack direction="horizontal" gap={3}>
                                    ...
                                    <Stack gap={1}>
                                        <div className="p-2">People</div>
                                        {
                                            species.people.map((x, i) =>
                                                <div key={i} className="p-2 d-flex flex-row-reverse"><Link to={getRelativeInnerPath(x)}>Person - {i+1}</Link></div>
                                            )}
                                    </Stack>
                                </Col>
